...
In today’s busy lifestyle, many individuals struggle with maintaining fitness routines, tracking health metrics, and accessing reliable guidance. PulseUp addresses these challenges by providing an all-in-one digital fitness companion that supports both home and gym users with structured plans and intelligent assistance.
...
- Diet planning for bulking, shredding, and maintenance  
- Meditation and mindfulness modules  
- BMI and calorie calculation tools  
- Real-time step counter using device sensors  
...
- The AI chatbot answers fitness and wellness-related queries using OpenRouter API  
- Health metrics such as BMI, calories, and steps are calculated in real time  
...
- Built as an academic project with scope for future scalability  
