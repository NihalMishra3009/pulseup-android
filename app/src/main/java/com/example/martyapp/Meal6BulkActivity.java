...
public class Meal6BulkActivity extends AppCompatActivity {

    private Button btnProteins, btnCarbs, btnVeggies, btnHealthyfats;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meal6_bulk);
        ...
        btnVeggies = findViewById(R.id.btnVeggies);
        ...
        btnCarbs.setOnClickListener(view -> selectCategory("carbs"));
        btnVeggies.setOnClickListener(view -> selectCategory("veggies"));
    ...
    private void selectCategory(String category) {
        ...
        switch (category) {
            case "proteins":
                imgMeal.setImageResource(R.drawable.bm_dinner_protein);
                setButtonColors(btnProteins);
                break;
            case "carbs":
                imgMeal.setImageResource(R.drawable.bm_dinner_carbs);
                setButtonColors(btnCarbs);
                break;
            case "veggies":
                imgMeal.setImageResource(R.drawable.bm_dinner_veggies);
                setButtonColors(btnVeggies);
                break;
            case "healthyfats":
                imgMeal.setImageResource(R.drawable.bm_dinner_healthyfats);
    ...
    private void setButtonColors(Button selectedButton) {
        ...
        btnCarbs.setBackgroundColor(getResources().getColor(R.color.tott));
        btnCarbs.setTextColor(getResources().getColor(R.color.tett));
        btnVeggies.setBackgroundColor(getResources().getColor(R.color.tott));
        btnVeggies.setTextColor(getResources().getColor(R.color.tett));
