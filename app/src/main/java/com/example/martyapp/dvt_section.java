...
public class dvt_section extends AppCompatActivity {

    private TextView playVideoButton;

    @SuppressLint("WrongViewCast")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.diet_refervid);
        ...
        playVideoButton.setOnClickListener(v -> {
            Intent intent = new Intent(dvt_section.this, diet_playvid.class);
