...
public class clamshell_j extends AppCompatActivity {
    ...
    // Steps Data
    private int[] stepImages = {R.drawable.clamshel_s1, R.drawable.clamshel_s2, R.drawable.clamshel_s3};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.clamshell);
