...
public class pre_halfcrunches_j extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pre_halfcrunches);
        ...
        gotosteps.setOnClickListener(view -> {
            Toast.makeText(pre_halfcrunches_j.this, "Exercise started!", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(pre_halfcrunches_j.this, halfcrunches_j.class));
        });
    ...
    private void playVideo(Surface surface) {
        mediaPlayer = MediaPlayer.create(this, R.raw.halfcrunches_hw);
        if (mediaPlayer != null) {
