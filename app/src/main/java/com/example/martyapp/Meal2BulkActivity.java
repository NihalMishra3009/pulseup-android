...
public class Meal2BulkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meal2_bulk);
    ...
    private void selectCategory(String category) {
        ...
        switch (category) {
            case "proteins":
                imgMeal.setImageResource(R.drawable.bm_midmorningsnack_protien);
                setButtonColors(btnProteins);
                break;
            case "fruits":
                imgMeal.setImageResource(R.drawable.bm_midmorningsnack_fruits);
                setButtonColors(btnFruits);
                break;
            case "healthyfats":
                imgMeal.setImageResource(R.drawable.bm_midmorningsnack_healthyfat);
