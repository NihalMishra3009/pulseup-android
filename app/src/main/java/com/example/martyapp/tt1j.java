...
public class tt1j extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ghart1 = findViewById(R.id.ghart1);

        ghart1.setOnClickListener(view -> {
            Intent intent = new Intent(tt1j.this, dashboard.class);
