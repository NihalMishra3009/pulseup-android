...
public class pre_legraises_j extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pre_legraises);
        ...
        gotosteps.setOnClickListener(view -> {
            Toast.makeText(pre_legraises_j.this, "Exercise started!", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(pre_legraises_j.this, legraises_j.class));
        });
    ...
    private void playVideo(Surface surface) {
        mediaPlayer = MediaPlayer.create(this, R.raw.legraises_hw);
        if (mediaPlayer != null) {
