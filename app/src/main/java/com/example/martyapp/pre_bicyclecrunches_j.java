...
public class pre_bicyclecrunches_j extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pre_bicyclecrunches);
        ...
        gotosteps.setOnClickListener(view -> {
            Toast.makeText(pre_bicyclecrunches_j.this, "Exercise started!", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(pre_bicyclecrunches_j.this, bicyclecrunches_j.class));
        });
    ...
    private void playVideo(Surface surface) {
        mediaPlayer = MediaPlayer.create(this, R.raw.bicyclecrunches_hw);
        if (mediaPlayer != null) {
