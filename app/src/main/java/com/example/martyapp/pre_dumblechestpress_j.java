...
public class pre_dumblechestpress_j extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pre_dumblechestpress);
        ...
        gotosteps.setOnClickListener(view -> {
            Toast.makeText(pre_dumblechestpress_j.this, "Exercise started!", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(pre_dumblechestpress_j.this, dumblechestpress_j.class));
        });
    ...
    private void playVideo(Surface surface) {
        mediaPlayer = MediaPlayer.create(this, R.raw.dumblechestpress_gw);
        if (mediaPlayer != null) {
