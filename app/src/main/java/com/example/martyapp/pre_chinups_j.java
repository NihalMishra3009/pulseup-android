...
public class pre_chinups_j extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pre_chinups);
        ...
        gotosteps.setOnClickListener(view -> {
            Toast.makeText(pre_chinups_j.this, "Exercise started!", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(pre_chinups_j.this, chinups_j.class));
        });
    ...
    private void playVideo(Surface surface) {
        mediaPlayer = MediaPlayer.create(this, R.raw.chinups_gw);
        if (mediaPlayer != null) {
