...
public class chinups_j extends AppCompatActivity {
    ...
    // Steps Data
    private int[] stepImages = {R.drawable.chinups_s1, R.drawable.chinups_s2, R.drawable.chinups_s3};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chinups);
