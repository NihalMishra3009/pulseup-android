...
public class pre_glutebridge_j extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pre_glutebridge);
        ...
        gotosteps.setOnClickListener(view -> {
            Toast.makeText(pre_glutebridge_j.this, "Exercise started!", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(pre_glutebridge_j.this, glutebridge_j.class));
        });
    ...
    private void playVideo(Surface surface) {
        mediaPlayer = MediaPlayer.create(this, R.raw.glutebridge_hw);
        if (mediaPlayer != null) {
