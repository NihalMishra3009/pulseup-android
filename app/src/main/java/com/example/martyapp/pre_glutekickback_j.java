...
public class pre_glutekickback_j extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pre_glutekickback);
        ...
        gotosteps.setOnClickListener(view -> {
            Toast.makeText(pre_glutekickback_j.this, "Exercise started!", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(pre_glutekickback_j.this, glutekickback_j.class));
        });
    ...
    private void playVideo(Surface surface) {
        mediaPlayer = MediaPlayer.create(this, R.raw.glutekickback_hw);
        if (mediaPlayer != null) {
