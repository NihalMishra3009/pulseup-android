...
public class Meal7BulkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meal7_bulk);
    ...
    private void selectCategory(String category) {
        ...
        switch (category) {
            case "proteins":
                imgMeal.setImageResource(R.drawable.bm_beforebed_protein);
                setButtonColors(btnProteins);
                break;
            case "healthyfats":
                imgMeal.setImageResource(R.drawable.bm_beforebed_healthyfat);
