...
public class pre_squatsandbackwardlunges_j extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pre_squatsandbackwardlunges);
        ...
        gotosteps.setOnClickListener(view -> {
            Toast.makeText(pre_squatsandbackwardlunges_j.this, "Exercise started!", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(pre_squatsandbackwardlunges_j.this, squatsandbackwardlunges_j.class));
        });
    ...
    private void playVideo(Surface surface) {
        mediaPlayer = MediaPlayer.create(this, R.raw.squatsandbackwardlunges_hw);
        if (mediaPlayer != null) {
