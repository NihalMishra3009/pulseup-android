...
public class legraises_j extends AppCompatActivity {
    ...
    // Steps Data
    private int[] stepImages = {R.drawable.legraises_s1, R.drawable.legraises_s2, R.drawable.legraises_s3, R.drawable.legraises_s4};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.legraises);
