...
public class dumblelateralraises_j extends AppCompatActivity {
    ...
    // Steps Data
    private int[] stepImages = {R.drawable.dumblelateralraises_s1, R.drawable.dumblelateralraises_s2, R.drawable.dumblelateralraises_s3, R.drawable.dumblelateralraises_s4};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dumblelateralraises);
