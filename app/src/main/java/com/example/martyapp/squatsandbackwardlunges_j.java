...
public class squatsandbackwardlunges_j extends AppCompatActivity {
    ...
    // Steps Data
    private int[] stepImages = {R.drawable.squatsandbackwardlunges_s1, R.drawable.squatsandbackwardlunges_s2, R.drawable.squatsandbackwardlunges_s3, R.drawable.squatsandbackwardlunges_s4, R.drawable.squatsandbackwardlunges_s5};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.squatsandbackwardlunges);
