...
public class Meal4ShredActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meal4_shred);
    ...
    private void selectCategory(String category) {
        ...
        switch (category) {
            case "proteins":
                imgMeal.setImageResource(R.drawable.sm_preworkout_protein);
                setButtonColors(btnProteins);
                break;
            case "carbs":
                imgMeal.setImageResource(R.drawable.sm_preworkout_carbs);
                setButtonColors(btnCarbs);
                break;
            case "healthyfats":
                imgMeal.setImageResource(R.drawable.sm_preworkout_healthyfat);
