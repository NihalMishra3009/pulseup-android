...
public class pre_dumbleoverheadsquats_j extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pre_dumbleoverheadsquats);
        ...
        gotosteps.setOnClickListener(view -> {
            Toast.makeText(pre_dumbleoverheadsquats_j.this, "Exercise started!", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(pre_dumbleoverheadsquats_j.this, dumbleoverheadsquats_j.class));
        });
    ...
    private void playVideo(Surface surface) {
        mediaPlayer = MediaPlayer.create(this, R.raw.dumbleoverheadsquats_gw);
        if (mediaPlayer != null) {
