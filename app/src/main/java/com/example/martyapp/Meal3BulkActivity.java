...
public class Meal3BulkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meal3_bulk);
    ...
    private void selectCategory(String category) {
        ...
        switch (category) {
            case "proteins":
                imgMeal.setImageResource(R.drawable.bm_lunch_protien);
                setButtonColors(btnProteins);
                break;
            case "carbs":
                imgMeal.setImageResource(R.drawable.bm_lunch_carbs);
                setButtonColors(btnCarbs);
                break;
            case "veggies":
                imgMeal.setImageResource(R.drawable.bm_lunch_veggies);
                setButtonColors(btnVeggies);
                break;
            case "healthyfats":
                imgMeal.setImageResource(R.drawable.bm_lunch_healthyfat);
