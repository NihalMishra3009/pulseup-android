...
public class halfcrunches_j extends AppCompatActivity {
    ...
    // Steps Data
    private int[] stepImages = {R.drawable.halfcrunches_s1, R.drawable.halfcrunches_s2, R.drawable.halfcrunches_s3};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.halfcrunches);
