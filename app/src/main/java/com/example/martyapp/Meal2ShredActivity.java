...
public class Meal2ShredActivity extends AppCompatActivity {

    private Button btnProteins, btnHealthyfats, btnFruits;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meal2_shred);
    ...
    private void selectCategory(String category) {
        ...
        switch (category) {
            case "proteins":
                imgMeal.setImageResource(R.drawable.sm_midmorningsnack_protein);
                setButtonColors(btnProteins);
                break;
            case "fruits":
                imgMeal.setImageResource(R.drawable.sm_midmorningsnack_fruits);
                setButtonColors(btnFruits);
                break;
            case "healthyfats":
                imgMeal.setImageResource(R.drawable.sm_midmorningsnack_healthyfat);
