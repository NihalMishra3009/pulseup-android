...
public class pre_jumpingjacks_j extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pre_jumpingjacks);
        ...
        gotosteps.setOnClickListener(view -> {
            Toast.makeText(pre_jumpingjacks_j.this, "Exercise started!", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(pre_jumpingjacks_j.this, jumpingjacks_j.class));
        });
    ...
    private void playVideo(Surface surface) {
        mediaPlayer = MediaPlayer.create(this, R.raw.jumpingjacks_hw);
        if (mediaPlayer != null) {
