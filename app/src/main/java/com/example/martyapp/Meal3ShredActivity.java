...
public class Meal3ShredActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meal3_shred);
        ...
        btnVegetables.setOnClickListener(view -> selectCategory("carbs"));
    ...
    private void selectCategory(String category) {
        ...
        switch (category) {
            case "proteins":
                imgMeal.setImageResource(R.drawable.sm_lunch_protein);
                setButtonColors(btnProteins);
                break;
            case "carbs":
                imgMeal.setImageResource(R.drawable.sm_lunch_vegetables);
