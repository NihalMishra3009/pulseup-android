...
public class dumblechestpress_j extends AppCompatActivity {
    ...
    // Steps Data
    private int[] stepImages = {R.drawable.dumblechestpress_s1, R.drawable.dumblechestpress_s2, R.drawable.dumblechestpress_s3, R.drawable.dumblechestpress_s4};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dumblechestpress);
