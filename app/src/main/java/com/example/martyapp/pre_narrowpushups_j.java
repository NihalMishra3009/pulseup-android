...
public class pre_narrowpushups_j extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pre_narrowpushups);
        ...
        gotosteps.setOnClickListener(view -> {
            Toast.makeText(pre_narrowpushups_j.this, "Exercise started!", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(pre_narrowpushups_j.this, narrowpushups_j.class));
        });
    ...
    private void playVideo(Surface surface) {
        mediaPlayer = MediaPlayer.create(this, R.raw.narrowpushups_hw);
        if (mediaPlayer != null) {
