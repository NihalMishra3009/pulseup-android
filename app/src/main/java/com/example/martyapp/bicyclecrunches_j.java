...
public class bicyclecrunches_j extends AppCompatActivity {
    ...
    // Steps Data
    private int[] stepImages = {R.drawable.bicyclecrunches_s1, R.drawable.bicyclecrunches_s2, R.drawable.bicyclecrunches_s3};
