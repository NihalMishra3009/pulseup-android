...
public class jumpingjacks_j extends AppCompatActivity {
    ...
    // Steps Data
    private int[] stepImages = {R.drawable.jumpingjacks_s1, R.drawable.jumpingjacks_s2, R.drawable.jumpingjacks_s3, R.drawable.jumpingjacks_s4};
