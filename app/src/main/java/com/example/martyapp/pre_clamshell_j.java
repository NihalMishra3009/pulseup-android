...
public class pre_clamshell_j extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pre_clamshell);
        ...
        gotosteps.setOnClickListener(view -> {
            Toast.makeText(pre_clamshell_j.this, "Exercise started!", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(pre_clamshell_j.this, clamshell_j.class));
        });
    ...
    private void playVideo(Surface surface) {
        mediaPlayer = MediaPlayer.create(this, R.raw.clamshel_hw);
        if (mediaPlayer != null) {
