...
public class pre_overheadtriceppushdown_j extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pre_overheadtriceppushdown);
        ...
        gotosteps.setOnClickListener(view -> {
            Toast.makeText(pre_overheadtriceppushdown_j.this, "Exercise started!", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(pre_overheadtriceppushdown_j.this, overheadtriceppushdown_j.class));
        });
    ...
    private void playVideo(Surface surface) {
        mediaPlayer = MediaPlayer.create(this, R.raw.overheadtriceppushdown_gw);
        if (mediaPlayer != null) {
