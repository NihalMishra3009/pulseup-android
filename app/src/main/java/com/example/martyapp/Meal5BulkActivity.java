...
public class Meal5BulkActivity extends AppCompatActivity {

    private Button btnProteins, btnCarbs;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meal5_bulk);
    ...
    private void selectCategory(String category) {
        ...
        switch (category) {
            case "proteins":
                imgMeal.setImageResource(R.drawable.bm_postworkoutmeal_protein);
                setButtonColors(btnProteins);
                break;
            case "carbs":
                imgMeal.setImageResource(R.drawable.bm_postworkoutmeal_carbs);
