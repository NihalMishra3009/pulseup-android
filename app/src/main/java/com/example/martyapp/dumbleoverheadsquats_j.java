...
public class dumbleoverheadsquats_j extends AppCompatActivity {
    ...
    // Steps Data
    private int[] stepImages = {R.drawable.dumbleoverheadsquats_s1, R.drawable.dumbleoverheadsquats_s2, R.drawable.dumbleoverheadsquats_s3};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dumbleoverheadsquats);
