...
public class Meal1BulkActivity extends AppCompatActivity {

    private Button btnProteins, btnCarbs, btnFruits;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meal1_bulk);
        ...
        btnFruits.setOnClickListener(view -> selectCategory("fruits"));
    }
    ...
    private void selectCategory(String category) {
        ...
        switch (category) {
            case "proteins":
                imgMeal.setImageResource(R.drawable.bm_morningbreakfast_protien);
                setButtonColors(btnProteins);
                break;
            case "carbs":
                imgMeal.setImageResource(R.drawable.bm_morningbreakfast_carbs);
                setButtonColors(btnCarbs);
                break;
            case "fruits":
                imgMeal.setImageResource(R.drawable.bm_morningbreakfast_fruits);
                setButtonColors(btnFruits);
                break;
        }
    }
    ...
    private void setButtonColors(Button selectedButton) {
        ...
        btnFruits.setBackgroundColor(getResources().getColor(R.color.tott));
        btnFruits.setTextColor(getResources().getColor(R.color.tett));
