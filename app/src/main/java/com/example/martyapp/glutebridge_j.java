...
public class glutebridge_j extends AppCompatActivity {
    ...
    // Steps Data
    private int[] stepImages = {R.drawable.glutebridge_s1, R.drawable.glutebridge_s2, R.drawable.glutebridge_s3};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.glutebridge);
