...
public class Meal1ShredActivity extends AppCompatActivity {

    private Button btnProteins, btnCarbs, btnHealthyfats;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meal1_shred);
    ...
    private void selectCategory(String category) {
        ...
        switch (category) {
            case "proteins":
                imgMeal.setImageResource(R.drawable.sm_morningbreakfast_protein);
                setButtonColors(btnProteins);
                break;
            case "carbs":
                imgMeal.setImageResource(R.drawable.sm_morningbreakfast_carbs);
                setButtonColors(btnCarbs);
                break;
            case "healthyfats":
                imgMeal.setImageResource(R.drawable.sm_morningbreakfast_healthyfat);
