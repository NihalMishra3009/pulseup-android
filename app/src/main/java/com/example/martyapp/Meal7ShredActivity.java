...
public class Meal7ShredActivity extends AppCompatActivity {

    private Button btnProteins, btnHealthyfats;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meal7_shred);
    ...
    private void selectCategory(String category) {
        ...
        switch (category) {
            case "proteins":
                imgMeal.setImageResource(R.drawable.sm_beforebed_protein);
                setButtonColors(btnProteins);
                break;
            case "healthyfats":
                imgMeal.setImageResource(R.drawable.sm_beforebed_healthyfats);
