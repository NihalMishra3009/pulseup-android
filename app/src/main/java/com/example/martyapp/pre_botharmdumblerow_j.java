...
public class pre_botharmdumblerow_j extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pre_botharmdumblerow);
        ...
        gotosteps.setOnClickListener(view -> {
            Toast.makeText(pre_botharmdumblerow_j.this, "Exercise started!", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(pre_botharmdumblerow_j.this, botharmdumblerow_j.class));
        });
    ...
    private void playVideo(Surface surface) {
        mediaPlayer = MediaPlayer.create(this, R.raw.botharmdumblerow_gw);
        if (mediaPlayer != null) {
