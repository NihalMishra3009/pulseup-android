...
public class overheadtriceppushdown_j extends AppCompatActivity {
    ...
    // Steps Data
    private int[] stepImages = {R.drawable.overheadtriceppushdown_s1, R.drawable.overheadtriceppushdown_s2, R.drawable.overheadtriceppushdown_s3};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.overheadtriceppushdown);
