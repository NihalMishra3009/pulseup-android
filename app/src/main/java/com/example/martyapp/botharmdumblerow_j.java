...
public class botharmdumblerow_j extends AppCompatActivity {
    ...
    // Steps Data
    private int[] stepImages = {R.drawable.botharmdumblerow_s1, R.drawable.botharmdumblerow_s2, R.drawable.botharmdumblerow_s3};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.botharmdumblerow);
