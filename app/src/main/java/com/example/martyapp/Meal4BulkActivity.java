...
public class Meal4BulkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meal4_bulk);
    ...
    private void selectCategory(String category) {
        ...
        switch (category) {
            case "proteins":
                imgMeal.setImageResource(R.drawable.bm_preworkout_protein);
                setButtonColors(btnProteins);
                break;
            case "carbs":
                imgMeal.setImageResource(R.drawable.bm_preworkout_carbs);
