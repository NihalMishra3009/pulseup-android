...
public class glutekickback_j extends AppCompatActivity {
    ...
    // Steps Data
    private int[] stepImages = {R.drawable.glutekickback_s1, R.drawable.glutekickback_s2, R.drawable.glutekickback_s3, R.drawable.glutekickback_s4};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.glutekickback);
